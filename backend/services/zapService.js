...
export const initiateScan = async (targetUrl) => {
    ...
    await zap.ascan.enableScanners({ ids: '40018,40012', scanpolicyname: 'Default Policy' });
    ...
    console.log('[ZapService] Scan finished. Waiting 5 seconds for ZAP to finalize the report...');
